...
class Empresa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('EMPRESA Joyeria'),
      ), //findeappbar
      body: Center(
...
class Productos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('PRODUCTOS de Joyeria'),
      ), //findeappbar
      body: Center(
...
class Contactos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: new Text('CONTACTOS Joyeria'),
      ), //findeappbar
      body: Center(
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.cyan, image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/diegoalexeisantiagos/mis-imagenes/main/joyeriasostenible-t.jpg"), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
